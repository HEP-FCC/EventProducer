...
C     
C     Process: u u~ > t t~ h QED<=1 $ t t~ a z w+ w- h
C     Process: c c~ > t t~ h QED<=1 $ t t~ a z w+ w- h
C     Process: d d~ > t t~ h QED<=1 $ t t~ a z w+ w- h
C     Process: s s~ > t t~ h QED<=1 $ t t~ a z w+ w- h
C     Process: b b~ > t t~ h QED<=1 $ t t~ a z w+ w- h
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFS1_1(W(1,3),W(1,5),GC_37,MDL_MT,MDL_WT,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,2),W(1,6),GC_5,AMP(1))
      CALL FFS1_2(W(1,4),W(1,5),GC_37,MDL_MT,MDL_WT,W(1,2))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,2),W(1,3),W(1,6),GC_5,AMP(2))
