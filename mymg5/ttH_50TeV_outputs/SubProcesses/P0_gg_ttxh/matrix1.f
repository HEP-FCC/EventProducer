...
C     
C     Process: g g > t t~ h QED<=1 $ t t~ a z w+ w- h
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFS1_1(W(1,3),W(1,5),GC_37,MDL_MT,MDL_WT,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,7),W(1,6),GC_5,AMP(1))
      CALL FFS1_2(W(1,4),W(1,5),GC_37,MDL_MT,MDL_WT,W(1,8))
...
C     Amplitude(s) for diagram number 3
      CALL FFS1_0(W(1,9),W(1,6),W(1,5),GC_37,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,8),W(1,6),W(1,2),GC_5,AMP(4))
      CALL FFV1_2(W(1,4),W(1,1),GC_5,MDL_MT,MDL_WT,W(1,6))
      CALL FFV1_1(W(1,3),W(1,2),GC_5,MDL_MT,MDL_WT,W(1,4))
C     Amplitude(s) for diagram number 5
      CALL FFS1_0(W(1,6),W(1,4),W(1,5),GC_37,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,6),W(1,7),W(1,2),GC_5,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,8),W(1,4),W(1,1),GC_5,AMP(7))
