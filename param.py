...
'pp_llv01j_5f':[' di-vector with V -> ll (l=e,mu,ve,vm,vt) + 0/1 jets','inclusive','xqcut = 40, qCut = 60','110.3','1.0'],
...
'pp_vbf_h01j_5f':['vbf vector boson + 0/1 jets','inclusive','xqcut = 40, qCut = 60','84.17','1.0'],
...
'pp_v0123j_5f':['vector boson + 0/1/2/3 jets','inclusive','xqcut = 30, qCut = 45','8.886e+06','1.0'],
...
'pp_vv012j_5f':['di-vector boson + 0/1/2 jets','inclusive','xqcut = 40, qCut = 60','3.39e+04','1.0'],
...
'pp_tth01j_5f':['higgs associated with top pair + 0/1 jets','inclusive','xqcut = 80, qCut = 120','44.84','1.0'],
...
'pp_ll012j_5f_HT_0_200':['V -> ll (l=e,mu,ve,vm,vt) + ','0 < HT < 200','xqcut = 30, qCut = 45','0','1.0'],
...
'pp_ll012j_5f':['V -> ll (l=e,mu,ve,vm,vt) + ','inclusive','xqcut = 30, qCut = 45','1.235e+04','1.0'],
'pp_h012j_5f_HT_0_100':['gluon fusion higgs (finite mt) + 0/1/2 jets','0 < HT < 100','xqcut = 30, qCut = 45','313.4','1.0'],
...
'pp_h012j_5f':['gluon fusion higgs (finite mt) + 0/1/2 jets','inclusive','xqcut = 30, qCut = 45','587.5','1.0'],
