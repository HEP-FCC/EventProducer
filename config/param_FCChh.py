...
#yaml directory
yamldir='/afs/cern.ch/work/f/fccsw/public/FCCDicts/yaml/FCC/'

#heppy and proc lists
heppyList = '/afs/cern.ch/work/f/fccsw/public/FCCDicts/FCC_heppySampleList_VERSION.py'
procList = '/afs/cern.ch/work/f/fccsw/public/FCCDicts/FCC_procDict_VERSION.json'
