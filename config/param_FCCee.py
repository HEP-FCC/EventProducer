...
# ee->H + background, ecm = 125 GeV:
    'wzp6_ee_l1l2nunu_ecm125':['ee -> l1l2nunu (l1!=l2, no H) ecm=125GeV','test','','5.799e-03','1.0','1.0'],
    'wzp6_ee_eenunu_ecm125':['ee -> eenunu (no H) ecm=125GeV','test','','3.364e-01','1.0','1.0'],
    'wzp6_ee_mumununu_ecm125':['ee -> mumununu (no H) ecm=125GeV','test','','2.202e-01','1.0','1.0'],
    'wzp6_ee_tautaununu_ecm125':['ee -> tautaununu (no H) ecm=125GeV','test','','4.265e-02','1.0','1.0'],

    'wzp6_ee_enueqq_ecm125':['ee -> enuqq (no H) ecm=125GeV','test','','1.382e-02','1.0','1.0'],
    'wzp6_ee_munumuqq_ecm125':['ee -> munuqq (no H) ecm=125GeV','test','','6.711e-03','1.0','1.0'],
    'wzp6_ee_taunutauqq_ecm125':['ee -> taunuqq (no H) ecm=125GeV','test','','6.761e-03','1.0','1.0'],
