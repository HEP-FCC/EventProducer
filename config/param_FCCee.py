...
prodTag = {
    ...
    'pre_summer2026_training':'/cvmfs/sw-nightlies.hsf.org/key4hep/releases/2026-06-06/x86_64-almalinux9-gcc14.2.0-opt/key4hep-stack/2026-06-06-3mtemo/setup.sh',
}
...
#Lb = 0.307 * 0.037 = 0.011359
    ...
    'p8_ee_Zbb_ecm91_EvtGen_Bd2D0Pi0D2Kspi0'    :['Z/Gamma* ecm=91.188GeV to bb','EvtGen B0 -> D0 pi0, D0 -> (Ks0 -> pi+ pi-) pi0','','1','1.0','1.0'],
    'p8_ee_Zbb_ecm91_EvtGen_Bd2D0Pi0D2Kspipi'   :['Z/Gamma* ecm=91.188GeV to bb','EvtGen B0 -> D0 pi0, D0 -> Ks0 pi+ pi-','','1','1.0','1.0'],
    'p8_ee_Zbb_ecm91_EvtGen_Bd2D0OmegaD02KK'    :['Z/Gamma* ecm=91.188GeV to bb','EvtGen B0 -> D0 omega, D0 -> K+ K-','','1','1.0','1.0'],
    'p8_ee_Zbb_ecm91_EvtGen_Bd2D0OmegaD02Kspi0' :['Z/Gamma* ecm=91.188GeV to bb','EvtGen B0 -> D0 omega, D0 -> (Ks0 -> pi+ pi-) pi0','','1','1.0','1.0'],
    'p8_ee_Zbb_ecm91_EvtGen_Bd2D0OmegaD02Kspipi':['Z/Gamma* ecm=91.188GeV to bb','EvtGen B0 -> D0 omega, D0 -> Ks0 pi+ pi-','','1','1.0','1.0'],
...
gridpacklist = {
    ...
    'wzp6_ee_bbH_mH-higher-50MeV_ecm240':['bbH ecm=240 GeV, vary mH','inclusive Higgs decays','','2.966e-02','1.0','1.0'],
    'wzp6_ee_bbH_mH-lower-50MeV_ecm240':['bbH ecm=240 GeV, vary mH','inclusive Higgs decays','','2.972e-02','1.0','1.0'],
    'wzp6_ee_bbH_BES-higher-1pc_ecm240':['bbH ecm=240 GeV, vary BES','inclusive Higgs decays','','2.972e-02','1.0','1.0'],
    'wzp6_ee_bbH_BES-lower-1pc_ecm240':['bbH ecm=240 GeV, vary BES','inclusive Higgs decays','','2.969e-02','1.0','1.0'],
    'wzp6_ee_ccH_mH-higher-50MeV_ecm240':['ccH ecm=240 GeV, vary mH','inclusive Higgs decays','','2.331e-02','1.0','1.0'],
    'wzp6_ee_ccH_mH-lower-50MeV_ecm240':['ccH ecm=240 GeV, vary mH','inclusive Higgs decays','','2.338e-02','1.0','1.0'],
    'wzp6_ee_ccH_BES-higher-1pc_ecm240':['ccH ecm=240 GeV, vary BES','inclusive Higgs decays','','2.333e-02','1.0','1.0'],
    'wzp6_ee_ccH_BES-lower-1pc_ecm240':['ccH ecm=240 GeV, vary BES','inclusive Higgs decays','','2.333e-02','1.0','1.0'],
    'wzp6_ee_ssH_mH-higher-50MeV_ecm240':['ssH ecm=240 GeV, vary mH','inclusive Higgs decays','','2.992e-02','1.0','1.0'],
    'wzp6_ee_ssH_mH-lower-50MeV_ecm240':['ssH ecm=240 GeV, vary mH','inclusive Higgs decays','','3.002e-02','1.0','1.0'],
    'wzp6_ee_ssH_BES-higher-1pc_ecm240':['ssH ecm=240 GeV, vary BES','inclusive Higgs decays','','2.995e-02','1.0','1.0'],
    'wzp6_ee_ssH_BES-lower-1pc_ecm240':['ssH ecm=240 GeV, vary BES','inclusive Higgs decays','','2.997e-02','1.0','1.0'],
    'wzp6_ee_qqH_mH-higher-50MeV_ecm240':['qqH ecm=240 GeV, q = u,d, vary mH','inclusive Higgs decays','','5.326e-02','1.0','1.0'],
    'wzp6_ee_qqH_mH-lower-50MeV_ecm240':['qqH ecm=240 GeV, q = u,d, vary mH','inclusive Higgs decays','','5.338e-02','1.0','1.0'],
    'wzp6_ee_qqH_BES-higher-1pc_ecm240':['qqH ecm=240 GeV, q = u,d, vary BES','inclusive Higgs decays','','5.332e-02','1.0','1.0'],
    'wzp6_ee_qqH_BES-lower-1pc_ecm240':['qqH ecm=240 GeV, q = u,d, vary BES','inclusive Higgs decays','','5.334e-02','1.0','1.0'],
    'wzp6_ee_tautauH_mH-higher-50MeV_ecm240':['tautauH ecm=240 GeV, vary mH','inclusive Higgs decays','','6.735e-03','1.0','1.0'],
    'wzp6_ee_tautauH_mH-lower-50MeV_ecm240':['tautauH ecm=240 GeV, vary mH','inclusive Higgs decays','','6.761e-03','1.0','1.0'],
    'wzp6_ee_tautauH_BES-higher-1pc_ecm240':['tautauH ecm=240 GeV, vary BES','inclusive Higgs decays','','6.747e-03','1.0','1.0'],
    'wzp6_ee_tautauH_BES-lower-1pc_ecm240':['tautauH ecm=240 GeV, vary BES','inclusive Higgs decays','','6.746e-03','1.0','1.0'],
    'wzp6_ee_nunuH_mH-higher-50MeV_ecm240':['nunuH ecm=240 GeV (all nu flavours), vary mH','inclusive Higgs decays','','4.611e-02','1.0','1.0'],
    'wzp6_ee_nunuH_mH-lower-50MeV_ecm240':['nunuH ecm=240 GeV (all nu flavours), vary mH','inclusive Higgs decays','','4.625e-02','1.0','1.0'],
    'wzp6_ee_nunuH_BES-higher-1pc_ecm240':['nunuH ecm=240 GeV (all nu flavours), vary BES','inclusive Higgs decays','','4.615e-02','1.0','1.0'],
    'wzp6_ee_nunuH_BES-lower-1pc_ecm240':['nunuH ecm=240 GeV (all nu flavours), vary BES','inclusive Higgs decays','','4.620e-02','1.0','1.0'],

    'wzp6_ee_nunuH_ecm240':['nunuH ecm=240 GeV (all nu flavours)','inclusive Higgs decays','','46.191e-3','1.0','1.0'],
    'wzp6_ee_qqH_ecm240':['qqH ecm=240 GeV, q = u,d','inclusive Higgs decays','','5.3337e-2','1.0','1.0'],
...
# for Higgs, sqrts = 365 GeV:
    ...
    'wzp6_ee_bbH_mH-higher-50MeV_ecm365':['bbH ecm=365 GeV, vary mH','inclusive Higgs decays','','1.838e-02','1.0','1.0'],
    'wzp6_ee_bbH_mH-lower-50MeV_ecm365':['bbH ecm=365 GeV, vary mH','inclusive Higgs decays','','1.839e-02','1.0','1.0'],
    'wzp6_ee_bbH_BES-higher-1pc_ecm365':['bbH ecm=365 GeV, vary BES','inclusive Higgs decays','','1.837e-02','1.0','1.0'],
    'wzp6_ee_bbH_BES-lower-1pc_ecm365':['bbH ecm=365 GeV, vary BES','inclusive Higgs decays','','1.838e-02','1.0','1.0'],
    'wzp6_ee_ccH_mH-higher-50MeV_ecm365':['ccH ecm=365 GeV, vary mH','inclusive Higgs decays','','1.443e-02','1.0','1.0'],
    'wzp6_ee_ccH_mH-lower-50MeV_ecm365':['ccH ecm=365 GeV, vary mH','inclusive Higgs decays','','1.444e-02','1.0','1.0'],
    'wzp6_ee_ccH_BES-higher-1pc_ecm365':['ccH ecm=365 GeV, vary BES','inclusive Higgs decays','','1.444e-02','1.0','1.0'],
    'wzp6_ee_ccH_BES-lower-1pc_ecm365':['ccH ecm=365 GeV, vary BES','inclusive Higgs decays','','1.444e-02','1.0','1.0'],
    'wzp6_ee_ssH_mH-higher-50MeV_ecm365':['ssH ecm=365 GeV, vary mH','inclusive Higgs decays','','1.852e-02','1.0','1.0'],
    'wzp6_ee_ssH_mH-lower-50MeV_ecm365':['ssH ecm=365 GeV, vary mH','inclusive Higgs decays','','1.854e-02','1.0','1.0'],
    'wzp6_ee_ssH_BES-higher-1pc_ecm365':['ssH ecm=365 GeV, vary BES','inclusive Higgs decays','','1.853e-02','1.0','1.0'],
    'wzp6_ee_ssH_BES-lower-1pc_ecm365':['ssH ecm=365 GeV, vary BES','inclusive Higgs decays','','1.855e-02','1.0','1.0'],
    'wzp6_ee_qqH_mH-higher-50MeV_ecm365':['qqH ecm=365 GeV, q = u,d, vary mH','inclusive Higgs decays','','3.299e-02','1.0','1.0'],
    'wzp6_ee_qqH_mH-lower-50MeV_ecm365':['qqH ecm=365 GeV, q = u,d, vary mH','inclusive Higgs decays','','3.301e-02','1.0','1.0'],
    'wzp6_ee_qqH_BES-higher-1pc_ecm365':['qqH ecm=365 GeV, q = u,d, vary BES','inclusive Higgs decays','','3.298e-02','1.0','1.0'],
    'wzp6_ee_qqH_BES-lower-1pc_ecm365':['qqH ecm=365 GeV, q = u,d, vary BES','inclusive Higgs decays','','3.300e-02','1.0','1.0'],
    'wzp6_ee_tautauH_mH-higher-50MeV_ecm365':['tautauH ecm=365 GeV, vary mH','inclusive Higgs decays','','4.174e-03','1.0','1.0'],
    'wzp6_ee_tautauH_mH-lower-50MeV_ecm365':['tautauH ecm=365 GeV, vary mH','inclusive Higgs decays','','4.176e-03','1.0','1.0'],
    'wzp6_ee_tautauH_BES-higher-1pc_ecm365':['tautauH ecm=365 GeV, vary BES','inclusive Higgs decays','','4.171e-03','1.0','1.0'],
    'wzp6_ee_tautauH_BES-lower-1pc_ecm365':['tautauH ecm=365 GeV, vary BES','inclusive Higgs decays','','4.171e-03','1.0','1.0'],
    'wzp6_ee_nunuH_mH-higher-50MeV_ecm365':['nunuH ecm=365 GeV (all nu flavours), vary mH','inclusive Higgs decays','','5.395e-02','1.0','1.0'],
    'wzp6_ee_nunuH_mH-lower-50MeV_ecm365':['nunuH ecm=365 GeV (all nu flavours), vary mH','inclusive Higgs decays','','5.396e-02','1.0','1.0'],
    'wzp6_ee_nunuH_BES-higher-1pc_ecm365':['nunuH ecm=365 GeV (all nu flavours), vary BES','inclusive Higgs decays','','5.402e-02','1.0','1.0'],
    'wzp6_ee_nunuH_BES-lower-1pc_ecm365':['nunuH ecm=365 GeV (all nu flavours), vary BES','inclusive Higgs decays','','5.393e-02','1.0','1.0'],
    ...
    'wzp6_ee_qqH_Hinv_ecm240':['ee->qqH, ecm=240 GeV','H->invisible', '','5.601e-05','1.0','1.0'],
    'wzp6_ee_ssH_Hinv_ecm240':['ee->ssH, ecm=240 GeV','H->invisible', '','3.146e-05','1.0','1.0'],
    'wzp6_ee_ccH_Hinv_ecm240':['ee->ccH, ecm=240 GeV','H->invisible', '','2.450e-05','1.0','1.0'],
    'wzp6_ee_bbH_Hinv_ecm240':['ee->bbH, ecm=240 GeV','H->invisible', '','3.146e-05','1.0','1.0'],
    'wzp6_ee_eeH_Hinv_ecm240':['ee->eeH, ecm=240 GeV','H->invisible', '','7.519e-06','1.0','1.0'],
    'wzp6_ee_mumuH_Hinv_ecm240':['ee->mumuH, ecm=240 GeV','H->invisible', '','7.103e-06','1.0','1.0'],
    'wzp6_ee_tautauH_Hinv_ecm240':['ee->tautauH, ecm=240 GeV','H->invisible', '','7.089e-06','1.0','1.0'],
    'wzp6_ee_nunuH_Hinv_ecm240':['ee->nunuH, ecm=240 GeV','H->invisible', '','4.8501e-05','1.0','1.0'],
...
# ttbar threshold scan
    ...
    'wzp6_ee_WbWb_PY6mod_ecm340': ['ee -> WbWb, ecm=340GeV','W inclusive, alternative PS parameters', '','0.0195','1.0','1.0'],
    'wzp6_ee_WbWb_PY6mod_ecm345': ['ee -> WbWb, ecm=345GeV','W inclusive, alternative PS parameters', '','0.0675','1.0','1.0'],
...
# ee->H + background, ecm = 125 GeV:
    ...
    'wzp6_ee_anunuH_Hbb_ecm365':['ee -> nunuH + photon, ecm=160GeV','H->bb','','1.552e-03','1.0','1.0'],
    
    'wzp6_ee_anunuH_HWW_ecm160':['ee -> nunuH + photon, ecm=160GeV','H->WW','','1.328e-08','1.0','1.0'],
    'wzp6_ee_anunuH_HWW_ecm240':['ee -> nunuH + photon, ecm=160GeV','H->WW','','8.366e-05','1.0','1.0'],
    'wzp6_ee_anunuH_HWW_ecm365':['ee -> nunuH + photon, ecm=160GeV','H->WW','','5.830e-04','1.0','1.0'],
    ...
    'wzp6_ee_Hmumununu_ecm125':['ee -> H -> WW* ecm=125GeV','W(munu)W*(munu)','','3.631e-06','1.0','1.0'],
    'wzp6_ee_Hmutaununu_ecm125':['ee -> H -> WW* ecm=125GeV','W(munu)W*(taunu)','','3.631e-06','1.0','1.0'],
    'wzp6_ee_Htauenunu_ecm125':['ee -> H -> WW* ecm=125GeV','W(taunu)W*(enu)','','3.631e-06','1.0','1.0'],
    'wzp6_ee_Htaumununu_ecm125':['ee -> H -> WW* ecm=125GeV','W(taunu)W*(munu)','','3.631e-06','1.0','1.0'],
    'wzp6_ee_Htautaununu_ecm125':['ee -> H -> WW* ecm=125GeV','W(taunu)W*(taunu)','','3.631e-06','1.0','1.0'],





    'wzp6_ee_bbH_ecm240':['ee->bbH, ecm=240 GeV','H->incl.', '','2.970e-02','1.0','1.0'],
    'wzp6_ee_ccH_ecm240':['ee->ccH, ecm=240 GeV','H->incl.', '','2.335e-02','1.0','1.0'],
    'wzp6_ee_ssH_ecm240':['ee->ssH, ecm=240 GeV','H->incl.', '','2.994e-02','1.0','1.0'],
    ...
    'wzp6_ee_qqH_Hinv_ecm365':['ee->qqH, ecm=365 GeV','H->invisible', '','3.456e-05','1.0','1.0'],
    'wzp6_ee_ssH_Hinv_ecm365':['ee->ssH, ecm=365 GeV','H->invisible', '','1.942e-05','1.0','1.0'],
    'wzp6_ee_ccH_Hinv_ecm365':['ee->ccH, ecm=365 GeV','H->invisible', '','1.513e-05','1.0','1.0'],
    'wzp6_ee_bbH_Hinv_ecm365':['ee->bbH, ecm=365 GeV','H->invisible', '','1.926e-05','1.0','1.0'],
    'wzp6_ee_eeH_Hinv_ecm365':['ee->eeH, ecm=365 GeV','H->invisible', '','7.738e-06','1.0','1.0'],
    'wzp6_ee_mumuH_Hinv_ecm365':['ee->mumuH, ecm=365 GeV','H->invisible', '','4.380e-06','1.0','1.0'],
    'wzp6_ee_tautauH_Hinv_ecm365':['ee->tautauH, ecm=365 GeV','H->invisible', '','4.373e-06','1.0','1.0'],
    'wzp6_ee_nunuH_Hinv_ecm365':['ee->nunuH, ecm=365 GeV','H->invisible', '','5.652e-05','1.0','1.0'],
    ...
    'wzp6_ee_tautauH_Hss_ecm365':['ee->tautauH, ecm=365 GeV','H->ss', '','1.002e-06','1.0','1.0'],
    ...
    'wzp6_ee_bba_ecm160':['ee -> b b gamma,  ecm=160 GeV','','','8.061','1.0','1.0'],
    'wzp6_ee_bba_ecm240':['ee -> b b gamma,  ecm=240 GeV','','','2.350','1.0','1.0'],
    'wzp6_ee_bba_ecm365':['ee -> b b gamma,  ecm=365 GeV','','','0.985','1.0','1.0'],

    'wzp6_ee_cca_ecm160':['ee -> c c gamma,  ecm=160 GeV','','','7.445','1.0','1.0'],
    'wzp6_ee_cca_ecm240':['ee -> c c gamma,  ecm=240 GeV','','','2.155','1.0','1.0'],
    'wzp6_ee_cca_ecm365':['ee -> c c gamma,  ecm=365 GeV','','','0.954','1.0','1.0'],

    'wzp6_ee_eea_ecm160':['ee -> e e gamma,  ecm=160 GeV','','','920.5','1.0','1.0'],
    'wzp6_ee_eea_ecm240':['ee -> e e gamma,  ecm=240 GeV','','','195.8','1.0','1.0'],
    'wzp6_ee_eea_ecm365':['ee -> e e gamma,  ecm=365 GeV','','','131.1','1.0','1.0'],

    'wzp6_ee_mumua_ecm160':['ee -> mu mu gamma,  ecm=160 GeV','','','2.818','1.0','1.0'],
    'wzp6_ee_mumua_ecm240':['ee -> mu mu gamma,  ecm=240 GeV','','','8.029e-1','1.0','1.0'],
    'wzp6_ee_mumua_ecm365':['ee -> mu mu gamma,  ecm=365 GeV','','','3.820e-1','1.0','1.0'],

    'wzp6_ee_qqa_ecm160':['ee -> q q gamma,  ecm=160 GeV','','','24.188','1.0','1.0'],
    'wzp6_ee_qqa_ecm240':['ee -> q q gamma,  ecm=240 GeV','','','6.978','1.0','1.0'],
    'wzp6_ee_qqa_ecm365':['ee -> q q gamma,  ecm=365 GeV','','','2.983','1.0','1.0'],

    'wzp6_ee_tautaua_ecm160':['ee -> tau tau gamma,  ecm=160 GeV','','','2.598','1.0','1.0'],
    ...
    'wzp6_ee_lnuqq_ecm157':['ee -> l nu q q,  ecm=157 GeV','','','1.0','1.0','1.0'],
    'wzp6_ee_lnuqq_ecm160':['ee -> l nu q q,  ecm=160 GeV','','','9.829e-01','1.0','1.0'],
    'wzp6_ee_lnuqq_ecm163':['ee -> l nu q q,  ecm=163 GeV','','','1.0','1.0','1.0'],
    ...
    'wzp6_ee_munumuqq_Vcb_ecm160':['ee -> mu numu q q,  ecm=160 GeV','W(munu)W(qq), Vcb', '','1.0','1.0','1.0'],
    'wzp6_ee_munumuqq_Vcd_ecm160':['ee -> mu numu q q,  ecm=160 GeV','W(munu)W(qq), Vcd', '','1.0','1.0','1.0'],
    'wzp6_ee_munumuqq_Vcs_ecm160':['ee -> mu numu q q,  ecm=160 GeV','W(munu)W(qq), Vcs', '','1.0','1.0','1.0'],
    'wzp6_ee_munumuqq_Vub_ecm160':['ee -> mu numu q q,  ecm=160 GeV','W(munu)W(qq), Vub', '','1.0','1.0','1.0'],
    'wzp6_ee_munumuqq_Vud_ecm160':['ee -> mu numu q q,  ecm=160 GeV','W(munu)W(qq), Vud', '','1.0','1.0','1.0'],
    'wzp6_ee_munumuqq_Vus_ecm160':['ee -> mu numu q q,  ecm=160 GeV','W(munu)W(qq), Vus', '','1.0','1.0','1.0'],
    ...
    # hadronic WW/ZZ/qq 4q CKM samples at ecm163 (mlevere) -- resonance_history, WW->4q per CKM combo
    'wzp6_ee_qq_4q_ecm163':['ee -> q q q q (QCD 4q, restr 5+6~gl),  ecm=163 GeV','hadronic 4-quark','','2.866','1.0','1.0'],
    'wzp6_ee_zz_4q_ecm163':['ee -> q q q q (ZZ/AA -> 4q),  ecm=163 GeV','hadronic 4-quark neutral','','0.4878','1.0','1.0'],
    'wzp6_ee_ww_4q_Vud_Vud_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vud Vud','','0.5156','1.0','1.0'],
    'wzp6_ee_ww_4q_Vud_Vus_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vud Vus','','0.02779','1.0','1.0'],
    'wzp6_ee_ww_4q_Vud_Vub_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vud Vub','','7.039e-06','1.0','1.0'],
    'wzp6_ee_ww_4q_Vud_Vcd_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vud Vcd','','0.02773','1.0','1.0'],
    'wzp6_ee_ww_4q_Vud_Vcs_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vud Vcs','','0.513','1.0','1.0'],
    'wzp6_ee_ww_4q_Vud_Vcb_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vud Vcb','','0.0008877','1.0','1.0'],
    'wzp6_ee_ww_4q_Vus_Vud_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vus Vud','','0.0278','1.0','1.0'],
    'wzp6_ee_ww_4q_Vus_Vus_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vus Vus','','0.001502','1.0','1.0'],
    'wzp6_ee_ww_4q_Vus_Vub_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vus Vub','','3.823e-07','1.0','1.0'],
    'wzp6_ee_ww_4q_Vus_Vcd_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vus Vcd','','0.001507','1.0','1.0'],
    'wzp6_ee_ww_4q_Vus_Vcs_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vus Vcs','','0.02775','1.0','1.0'],
    'wzp6_ee_ww_4q_Vus_Vcb_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vus Vcb','','4.804e-05','1.0','1.0'],
    'wzp6_ee_ww_4q_Vub_Vud_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vub Vud','','7.058e-06','1.0','1.0'],
    'wzp6_ee_ww_4q_Vub_Vus_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vub Vus','','3.82e-07','1.0','1.0'],
    'wzp6_ee_ww_4q_Vub_Vub_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vub Vub','','9.722e-11','1.0','1.0'],
    'wzp6_ee_ww_4q_Vub_Vcd_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vub Vcd','','3.792e-07','1.0','1.0'],
    'wzp6_ee_ww_4q_Vub_Vcs_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vub Vcs','','7.025e-06','1.0','1.0'],
    'wzp6_ee_ww_4q_Vub_Vcb_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vub Vcb','','1.222e-08','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcd_Vud_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcd Vud','','0.0277','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcd_Vus_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcd Vus','','0.001495','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcd_Vub_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcd Vub','','3.802e-07','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcd_Vcd_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcd Vcd','','0.001498','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcd_Vcs_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcd Vcs','','0.02766','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcd_Vcb_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcd Vcb','','4.797e-05','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcs_Vud_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcs Vud','','0.5135','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcs_Vus_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcs Vus','','0.02762','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcs_Vub_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcs Vub','','7.056e-06','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcs_Vcd_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcs Vcd','','0.02765','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcs_Vcs_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcs Vcs','','0.5127','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcs_Vcb_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcs Vcb','','0.0008885','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcb_Vud_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcb Vud','','0.0008866','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcb_Vus_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcb Vus','','4.802e-05','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcb_Vub_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcb Vub','','1.221e-08','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcb_Vcd_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcb Vcd','','4.807e-05','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcb_Vcs_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcb Vcs','','0.0008898','1.0','1.0'],
    'wzp6_ee_ww_4q_Vcb_Vcb_ecm163':['ee -> q q q q (WW -> 4q),  ecm=163 GeV','WW hadronic, Vcb Vcb','','1.544e-06','1.0','1.0'],
}
