...
'mg_pp_llaj_mhcut_5f_HT_20_100':['l+ l- a + 1 jet','20 < HT < 100','','1.842','','1.0'],
'mg_pp_llaj_mhcut_5f_HT_100_400':['l+ l- a + 1 jet','100 < HT < 400','','2','','1.0'],
# xsec to be determined
'mg_pp_llaj_mhcut_5f_HT_400_27000':['l+ l- a + 1 jet','400 < HT < 27000','','2','','1.0'],
'mg_pp_llllj_mhcut_5f_HT_20_100':['4l + 1 jet','20 < HT < 100','','0.00226','','1.0'],
'mg_pp_llllj_mhcut_5f_HT_100_400':['4l + 1 jet','100 < HT < 400','','0.0004216','','1.0'],
'mg_pp_llllj_mhcut_5f_HT_400_27000':['4l + 1 jet','400 < HT < 27000','','1.996e-06','','1.0'],
'mg_pp_mumuj_mhcut_5f_HT_20_100':['mu+ mu- + 1 jet','20 < HT < 100','','27.15','','1.0'],
'mg_pp_mumuj_mhcut_5f_HT_100_400':['mu+ mu- + 1 jet','100 < HT < 400','','2.34','','1.0'],
'mg_pp_mumuj_mhcut_5f_HT_400_27000':['mu+ mu- + 1 jet','400 < HT < 27000','','0.0285','','1.0'],
'mg_pp_aa012j_5f_HT_0_200':['di-photon + 0/1/2 jets','0 < HT < 200','xqcut = 20, qCut = 30','1729','2.0','1.0'],
'mg_pp_aa012j_5f_HT_200_600':['di-photon + 0/1/2 jets','200 < HT < 600','xqcut = 20, qCut = 30','157.4','2.0','1.0'],
'mg_pp_aa012j_5f_HT_600_27000':['di-photon + 0/1/2 jets','600 < HT < 27000','xqcut = 20, qCut = 30','8.566','2.0','1.0'],
'mg_gg_aa01j_5f_HT_0_200':['gluon fusion di-photon + 0/1 jets','0 < HT < 200','xqcut = 20, qCut = 30','179.6','2.0','1.0'],
'mg_gg_aa01j_5f_HT_200_600':['gluon fusion di-photon + 0/1 jets','200 < HT < 600','xqcut = 20, qCut = 30','1.275','2.0','1.0'],
'mg_gg_aa01j_5f_HT_600_27000':['gluon fusion di-photon + 0/1 jets','600 < HT < 27000','xqcut = 20, qCut = 30','0.02109','2.0','1.0'],

'mg_pp_vh012j_5f_HT_0_27000':['higgsstrahlung + 0/1/2 jets','0 < HT < 27000','xqcut = 40, qCut = 60','7.255','1.32','1.0'],
'mg_pp_vbf_h01j_5f_HT_0_27000':['vbf higgs + 0/1 jets','0 < HT < 27000','xqcut = 40, qCut = 60','13.89','1.20','1.0'],
'mg_pp_h012j_5f_HT_0_27000':['gluon fusion higgs (finite mt) + 0/1/2 jets','0 < HT < 27000','xqcut = 30, qCut = 45','88.8','3.76','1.0'],
'mg_pp_tth01j_5f_HT_0_27000':['higgs associated with top pair + 0/1 jets','0 < HT < 27000','xqcut = 80, qCut = 120','3.274','1.22','1.0'],
