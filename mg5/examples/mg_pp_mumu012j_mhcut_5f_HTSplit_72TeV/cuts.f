...
c     mh invariant mass cuts
      
c     reset ptemp
      do j=0,3
         ptemp(j)=0 ! for the total momentum
      enddo
      
c     compute total momentum excluding jets
      do i=nincoming+1,nexternal
      ...
      mh = dsqrt(ptemp(0)**2-ptemp(1)**2-ptemp(2)**2-ptemp(3)**2)
