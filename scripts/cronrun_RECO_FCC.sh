...
python bin/run.py --FCC --reco --checkeos --version fcc_v02_ATLASgran
python bin/run.py --FCC --reco --check --version fcc_v02_ATLASgran
python bin/run.py --FCC --reco --merge --version fcc_v02_ATLASgran
python bin/run.py --FCC --reco --clean --version fcc_v02_ATLASgran
python bin/run.py --FCC --reco --cleanold --version fcc_v02_ATLASgran
python bin/run.py --FCC --reco --merge --version fcc_v02_ATLASgran
python bin/run.py --FCC --reco --web --version fcc_v02_ATLASgran
