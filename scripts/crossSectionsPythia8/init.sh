...
g++ py8crossSection.cc -o py8crossSection.exe -I/cvmfs/sft.cern.ch/lcg/views/LCG_92/x86_64-slc6-gcc7-opt/include/ -L/cvmfs/sft.cern.ch/lcg/views/LCG_92/x86_64-slc6-gcc7-opt/lib/ -Wl,-rpath,/cvmfs/sft.cern.ch/lcg/views/LCG_92/x86_64-slc6-gcc7-opt/lib/ -lpythia8;
